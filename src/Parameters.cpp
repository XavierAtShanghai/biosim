...
SCALAR Parameters::get_nu() const {
...
SCALAR Parameters::get_rho() const {
...
SCALAR Parameters::get_c0() const {
...
SCALAR Parameters::get_fric() const {
...
SCALAR Parameters::get_phi() const {
...
int Parameters::get_solver() const {
...
int Parameters::get_orderFV() const {
